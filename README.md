...
- [ ] Explain what a token is used for. - to store an authorization key and ma
- [ ] What steps can you take in your web apps to keep your data secure?
      don't set specific key value pairs for logins. Set up private routes. set up authorization needs etc.

- [ ] Describe how web servers work. A server basially manages the reqeust to a specific website so when you hit that server it sends out and retreives the data you need to be rendered
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when get interfacing with APIs/Servers. C - Post R- Get U - Put -D Delete
